...
import 'package:stackmate_wallet/app/new_wallet/components/xpub_coldcard_import.dart';
...
class XPubColdcardPage extends StatelessWidget {
  const XPubColdcardPage({super.key});
